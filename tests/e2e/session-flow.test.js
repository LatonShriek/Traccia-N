...
module.exports = async function run(t) {
  ...
  // un rallentamento anomalo, la natura stessa dell'esercizio. Running
  // Span è ancora più lento: un "ciclo" è un'intera sequenza (più
  // elementi, ciascuno con il proprio ISI) seguita dal richiamo a
  // tastierino — anche un solo ciclo al minimo può avvicinarsi al
  // limite standard.
  const MAX_MS_OVERRIDE = { mantenimento: 70000, runningspan: 70000 };
