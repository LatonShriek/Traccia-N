...
module.exports = function run(t) {
  t.group('TITRATION_EXERCISES — perimetro dichiarato', () => {
    t.eq(TITRATION_EXERCISES.slice().sort(), ['ant', 'gonogo', 'nback', 'sequenza', 'stopsignal', 'switching'].sort(),
      'i 6 esercizi con stepper Livello condiviso sono esattamente quelli attesi — nessuno aggiunto o tolto senza che questo test lo segnali');
  });
